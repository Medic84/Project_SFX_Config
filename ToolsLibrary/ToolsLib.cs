...
*/
    ...
    public class MRUClass
    {
        ...
        public sealed class MruMenuItem : ToolStripMenuItem
        {
            /// <summary>
        ...
        public MRUClass(ToolStripMenuItem recentFileMenuItem, ClickedHandler clickedHandler)
        ...
        public MRUClass(ToolStripMenuItem recentFileMenuItem, ClickedHandler clickedHandler, string registryKeyName)
        ...
        /// <param name="registryKeyName"> </param>
        /// <param name="maxEntries"> </param>
        public MRUClass(ToolStripMenuItem recentFileMenuItem, ClickedHandler clickedHandler, string registryKeyName, int maxEntries)
        ...
        public MRUClass(ToolStripMenuItem recentFileMenuItem, ClickedHandler clickedHandler, string registryKeyName, bool loadFromRegistry)
        ...
        /// <param name="loadFromRegistry"> </param>
        /// <param name="maxEntries"> </param>
        public MRUClass(ToolStripMenuItem recentFileMenuItem, ClickedHandler clickedHandler, string registryKeyName, bool loadFromRegistry, int maxEntries)
        {
        ...
        public void SetFirstFile(int number)
        {
            ...
            {
                var menuItem = (MruMenuItem)MenuItems[StartIndex + number];
        ...
        public int FindFilenameNumber(string filename)
        {
            ...
            {
                var number = 0;
                for (var i = StartIndex; i < EndIndex; i++, number++)
                {
                    if (String.Compare(((MruMenuItem)MenuItems[i]).Filename, filename, StringComparison.OrdinalIgnoreCase) == 0)
                    {
                        return number;
                    }
                }
        ...
        {
            var filenames = new string[numEntries];

            var index = StartIndex;
            for (var i = 0; i < filenames.GetLength(0); i++, index++)
            {
        ...
        public void AddFile(string filename, string entryname)
        {
            ...
            {
                var menuItem = new MruMenuItem(filename, FixupEntryname(0, entryname), OnClick);
                MenuItems.Insert(StartIndex, menuItem);
                SetFirstFile(menuItem);
            ...
            {
                var menuItem = (MruMenuItem)MenuItems[StartIndex + numEntries - 1];
        ...
        public void RenameFile(string oldFilename, string newFilename, string newEntryname)
        {
            ...
            if (numEntries > 0)
            {
                ...
                if (index >= 0)
                {
                    var menuItem = (MruMenuItem)MenuItems[index];
        ...
        public void LoadFromRegistry()
        {
            if (registryKeyName != null)
            {
                ...
                if (regKey != null)
                {
                    ...
                    {
                        var filename = (string)regKey.GetValue("File" + number.ToString(CultureInfo.InvariantCulture));
                        if (filename != null)
                            AddFile(filename);
                    }
        ...
        public void SaveToRegistry()
        {
            if (registryKeyName != null)
            {
                ...
                var regKey = Registry.CurrentUser.CreateSubKey(registryKeyName);
                if (regKey != null)
                {
                    ...
                    {
                        regKey.SetValue("File" + number.ToString(CultureInfo.InvariantCulture), ((MruMenuItem)MenuItems[i]).Filename);
                    }

                    for (; number <= 16; number++)
                    {
                        regKey.DeleteValue("File" + number.ToString(CultureInfo.InvariantCulture), false);
                    }
    ...
    /// </remarks>
    public class MRUClassInline : MRUClass
    {
        ...
        //private MRUClassInline(

        public MRUClassInline(ToolStripMenuItem owningMenu, ToolStripMenuItem recentFileMenuItem, ClickedHandler clickedHandler)
            : this(owningMenu, recentFileMenuItem, clickedHandler, null, false, 4)
        {
        }

        public MRUClassInline(ToolStripMenuItem owningMenu, ToolStripMenuItem recentFileMenuItem, ClickedHandler clickedHandler, int maxEntries)
            : this(owningMenu, recentFileMenuItem, clickedHandler, null, false, maxEntries)
        {
        }

        public MRUClassInline(ToolStripMenuItem owningMenu, ToolStripMenuItem recentFileMenuItem, ClickedHandler clickedHandler, string registryKeyName)
            : this(owningMenu, recentFileMenuItem, clickedHandler, registryKeyName, true, 4)
        {
        }

        public MRUClassInline(ToolStripMenuItem owningMenu, ToolStripMenuItem recentFileMenuItem, ClickedHandler clickedHandler, string registryKeyName, int maxEntries)
            : this(owningMenu, recentFileMenuItem, clickedHandler, registryKeyName, true, maxEntries)
        {
        }

        public MRUClassInline(ToolStripMenuItem owningMenu, ToolStripMenuItem recentFileMenuItem, ClickedHandler clickedHandler, string registryKeyName, bool loadFromRegistry)
            : this(owningMenu, recentFileMenuItem, clickedHandler, registryKeyName, loadFromRegistry, 4)
        {
        }

        public MRUClassInline(ToolStripMenuItem owningMenu, ToolStripMenuItem recentFileMenuItem, ClickedHandler clickedHandler, string registryKeyName, bool loadFromRegistry, int maxEntries)
        {
